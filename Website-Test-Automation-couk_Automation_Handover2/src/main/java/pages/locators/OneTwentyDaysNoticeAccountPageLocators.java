...
public class OneTwentyDaysNoticeAccountPageLocators {
	
	@FindBy(xpath="//h1[normalize-space()='120 day notice account issue 2']")
	...
	@FindBy(xpath="//a[normalize-space()='Apply now for a 120 notice account account']")
