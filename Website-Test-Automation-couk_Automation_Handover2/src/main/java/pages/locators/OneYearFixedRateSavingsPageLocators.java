...
public class OneYearFixedRateSavingsPageLocators {

	// Masthead_Medium

	@FindBy(xpath = "//h1[normalize-space()='1 year fixed rate account']")
	public WebElement OneYearFixedRateHeader;

	// Masthead Black box

	@FindBy(xpath="//h2[normalize-space()='New customers']")
	public WebElement MastheadBlackBoxHeader;

	@FindBy(xpath="//h3[normalize-space()='Existing customers']")
	...
	@FindBy(xpath="//a[normalize-space()='Apply for a 1 year fixed rate account']")
