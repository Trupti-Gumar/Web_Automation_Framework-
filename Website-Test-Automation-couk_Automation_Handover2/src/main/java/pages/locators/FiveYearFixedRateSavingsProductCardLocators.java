...
public class FiveYearFixedRateSavingsProductCardLocators {

	// Masthead_Medium

	@FindBy(xpath = "//h1[normalize-space()='5 year fixed rate account']")
	...
	@FindBy(xpath="//a[normalize-space()='Apply now for a 5 year fixed rate account']")
