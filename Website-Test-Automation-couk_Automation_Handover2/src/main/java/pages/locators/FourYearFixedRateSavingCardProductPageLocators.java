...
public class FourYearFixedRateSavingCardProductPageLocators {

	// Masthead_Medium

	@FindBy(xpath = "//h1[normalize-space()='4 year fixed rate account']")
	...
	@FindBy(xpath="//a[normalize-space()='Apply now for a 4 year fixed rate account']")
