...
public class TwoYearFixedRateSavingsPageLocators {

	// Masthead_Medium

	@FindBy(xpath = "//h1[normalize-space()='2 year fixed rate account']")
	...
	@FindBy(xpath = "//a[normalize-space()='Apply now for a 2 year fixed rate account']")
	...
	// Cards-FixedRate Summary Box

	@FindBy(xpath = "//h2[normalize-space()='Fixed Rate Account Summary Box']")
	public WebElement FixedRateSummaryBoxCardHeader;

	@FindBy(xpath="//a[@aria-label='Download Fixed Rate Account Summary Box']")
	public WebElement FixedRateSummaryBoxCardDownloadLink;
