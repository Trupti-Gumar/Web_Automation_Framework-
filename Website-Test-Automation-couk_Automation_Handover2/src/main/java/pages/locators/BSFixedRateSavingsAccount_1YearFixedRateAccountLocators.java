...
public class BSFixedRateSavingsAccount_1YearFixedRateAccountLocators {
	...
	@FindBy(xpath = "//h1[normalize-space()='1 year fixed rate account']")
	...
	@FindBy(xpath="(//button[@data-parent-title='Product summary'])[1]")
	public WebElement FixedRateAccountFAQAccordian;

	@FindBy(xpath="(//div[@class='text-block text-block-grey'])[1]")
	...
	@FindBy(xpath="//a[contains(text(),'Apply now for a 1 year fixed rate business savings')]")
