...
public class CashISA_TwoYearFixedRateCashISAStepsLocators {
	...
	@FindBy(xpath="//a[normalize-space()='Apply now for a 2 year fixed rate cash ISA']")
	...
	@FindBy(xpath = "//div[@id='documents']//a[@aria-label='Download document'][normalize-space()='Download document']")
